...
public class DirectAccessProps implements Serializable {
    ...
    /**
     * 始终显示垂直滚动条，但平时隐蔽（较窄），拖动时展开
     * 默认为 false，启用后滚动条会始终可见
     */
    @InvalidateRequired
    public boolean alwaysShowVerticalScrollbar = false;
    
    /**
     * 滚动条默认宽度比例（相对于正常宽度），范围 0.0-1.0
     * 仅当 alwaysShowVerticalScrollbar 为 true 时有效
     */
    public float scrollbarIdleWidthRatio = 0.3f;
    
    /**
     * 滚动条默认透明度，范围 0-255
     * 仅当 alwaysShowVerticalScrollbar 为 true 时有效
     */
    public int scrollbarIdleAlpha = 80;
