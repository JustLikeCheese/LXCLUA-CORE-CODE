...
public class EditorColorScheme {
    ...
    //----------------Issue colors----------------
    public static final int PROBLEM_HINT = 88;
    ...
    public static final int GLOBAL_VARIABLE = 84;
    public static final int IDENTIFIER_QUALIFIER = 85;
    public static final int HEX_COLOR_WHITE = 86;
    public static final int HEX_COLOR_BLACK = 87;
    ...
    /**
     * Get color scheme that matches system theme
     *
     * @param context Context to get system theme from
     * @return Color scheme matching system theme
     */
    @NonNull
    public static EditorColorScheme getSystemThemeScheme(@NonNull Context context) {
        ...
        return new EditorColorScheme(isDarkTheme);
    }
    
    /**
     * Get dark theme color scheme
     *
     * @return Dark theme color scheme
     */
    @NonNull
    public static EditorColorScheme getDarkThemeScheme() {
        return new EditorColorScheme(true);
    }
    
    /**
     * Get light theme color scheme
     *
     * @return Light theme color scheme
     */
    @NonNull
    public static EditorColorScheme getLightThemeScheme() {
        return new EditorColorScheme(false);
    }
