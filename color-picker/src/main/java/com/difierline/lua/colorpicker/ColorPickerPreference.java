...
import com.difierline.lua.colorpicker.builder.ColorPickerClickListener;
import com.difierline.lua.colorpicker.builder.ColorPickerDialogBuilder;
...
public class ColorPickerPreference extends Preference {
	...
	protected void onBindView(@NonNull View view) {
		...
		colorIndicator.setBackgroundColor(0);
	}
