...
import com.difierline.lua.colorpicker.builder.ColorWheelRendererBuilder;
import com.difierline.lua.colorpicker.builder.PaintBuilder;
import com.difierline.lua.colorpicker.renderer.ColorWheelRenderOption;
...
public class ColorPickerView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (colorWheel != null && currentColorCircle != null) {
            ...
            // draw circle slightly larger than it needs to be, then erase edges to proper
            // dimensions
    ...
    private void setColorPreviewColor(int newColor) {
        ...
        childImage.setImageDrawable(colorDrawable);
    }
