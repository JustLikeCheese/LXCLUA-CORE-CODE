...
public class LuaLexer {
    private final com.yan.luaeditor.tools.tokenizer.LuaLexer lexer;

    public LuaLexer(String input) {
        this.lexer = new com.yan.luaeditor.tools.tokenizer.LuaLexer(new java.io.StringReader(input));
    }
