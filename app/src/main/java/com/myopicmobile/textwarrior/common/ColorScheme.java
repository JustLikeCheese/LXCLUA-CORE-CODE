...
public abstract class ColorScheme
{
	public enum Colorable
	{
		...
		GLOBAL, UPVAL, LOCAL, SECONDARY, HEX_COLOR, HEX_COLOR_HIGH_CONTRAST
		}
	...
	public int getTokenColor(int tokenType)
	{
		...
		switch (tokenType)
		{
			...
			case Lexer.OPERATOR:
				...
				break;
		    case Lexer.HEX_COLOR:
				element = Colorable.HEX_COLOR;
				break;
			case Lexer.HEX_COLOR_HIGH_CONTRAST:
				element = Colorable.HEX_COLOR_HIGH_CONTRAST;
				break;
			default:
	...
	private HashMap<Colorable, Integer> generateDefaultColors()
	{
	    ...
	    colors.put(Colorable.HEX_COLOR, 0xFF000000); // 黑色
        colors.put(Colorable.HEX_COLOR_HIGH_CONTRAST, 0xFFFFFFFF); // 白色
