...
/**
 * Created DifierLine on 2019/12/1.
 */
...
public class llex {
    ...
    final static String luaX_tokens[] = {
            ...
            "end", "enum", "false", "for", "function", "goto", "if",
    ...
    final static int
            ...
            TK_END = 265, TK_ENUM = 266, TK_FALSE = 267, TK_FOR = 268, TK_FUNCTION = 269, TK_GOTO = 270, TK_IF = 271,
            TK_IN = 272, TK_LOCAL = 273, TK_NIL = 274, TK_NOT = 275, TK_OR = 276, TK_REPEAT = 277,
            TK_RETURN = 278, TK_SWITCH = 279, TK_THEN = 280, TK_TRUE = 281, TK_UNTIL = 282, TK_WHILE = 283,
