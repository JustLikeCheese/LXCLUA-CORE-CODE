...
public class LanguageLua extends Language {
	...
	private final static String keywordTarget ="and|asm|break|case|catch|command|const|continue|default|do|else|elseif|end|enum|false|finally|for|function|goto|global|if|in|is|lambda|local|nil|not|or|repeat|return|switch|take|then|true|try|until|when|while|with";
