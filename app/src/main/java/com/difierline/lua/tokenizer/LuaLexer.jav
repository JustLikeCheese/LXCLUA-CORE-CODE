...
import static com.difierline.lua.tokenizer.LuaTokenTypes.AND;
import static com.difierline.lua.tokenizer.LuaTokenTypes.ASSIGN;
import static com.difierline.lua.tokenizer.LuaTokenTypes.AT;
import static com.difierline.lua.tokenizer.LuaTokenTypes.BAD_CHARACTER;
import static com.difierline.lua.tokenizer.LuaTokenTypes.BIT_AND;
import static com.difierline.lua.tokenizer.LuaTokenTypes.BIT_LTLT;
import static com.difierline.lua.tokenizer.LuaTokenTypes.BIT_OR;
import static com.difierline.lua.tokenizer.LuaTokenTypes.BIT_RTRT;
import static com.difierline.lua.tokenizer.LuaTokenTypes.BIT_TILDE;
import static com.difierline.lua.tokenizer.LuaTokenTypes.BLOCK_COMMENT;
import static com.difierline.lua.tokenizer.LuaTokenTypes.BREAK;
import static com.difierline.lua.tokenizer.LuaTokenTypes.CASE;
import static com.difierline.lua.tokenizer.LuaTokenTypes.COLON;
import static com.difierline.lua.tokenizer.LuaTokenTypes.COMMA;
import static com.difierline.lua.tokenizer.LuaTokenTypes.CONCAT;
import static com.difierline.lua.tokenizer.LuaTokenTypes.CONTINUE;
import static com.difierline.lua.tokenizer.LuaTokenTypes.DEFAULT;
import static com.difierline.lua.tokenizer.LuaTokenTypes.HEX_COLOR;
import static com.difierline.lua.tokenizer.LuaTokenTypes.DIV;
import static com.difierline.lua.tokenizer.LuaTokenTypes.DO;
import static com.difierline.lua.tokenizer.LuaTokenTypes.HEX_COLOR_HIGH_CONTRAST;
import static com.difierline.lua.tokenizer.LuaTokenTypes.DOC_COMMENT;
import static com.difierline.lua.tokenizer.LuaTokenTypes.DOT;
import static com.difierline.lua.tokenizer.LuaTokenTypes.DOUBLE_COLON;
import static com.difierline.lua.tokenizer.LuaTokenTypes.DOUBLE_DIV;
import static com.difierline.lua.tokenizer.LuaTokenTypes.ELLIPSIS;
import static com.difierline.lua.tokenizer.LuaTokenTypes.ELSE;
import static com.difierline.lua.tokenizer.LuaTokenTypes.ELSEIF;
import static com.difierline.lua.tokenizer.LuaTokenTypes.END;
import static com.difierline.lua.tokenizer.LuaTokenTypes.ENDREGION;
import static com.difierline.lua.tokenizer.LuaTokenTypes.EQ;
import static com.difierline.lua.tokenizer.LuaTokenTypes.EXP;
import static com.difierline.lua.tokenizer.LuaTokenTypes.FALSE;
import static com.difierline.lua.tokenizer.LuaTokenTypes.FOR;
import static com.difierline.lua.tokenizer.LuaTokenTypes.FUNCTION;
import static com.difierline.lua.tokenizer.LuaTokenTypes.GE;
import static com.difierline.lua.tokenizer.LuaTokenTypes.GETN;
import static com.difierline.lua.tokenizer.LuaTokenTypes.GOTO;
import static com.difierline.lua.tokenizer.LuaTokenTypes.GT;
import static com.difierline.lua.tokenizer.LuaTokenTypes.IF;
import static com.difierline.lua.tokenizer.LuaTokenTypes.IN;
import static com.difierline.lua.tokenizer.LuaTokenTypes.LBRACK;
import static com.difierline.lua.tokenizer.LuaTokenTypes.LCURLY;
import static com.difierline.lua.tokenizer.LuaTokenTypes.LE;
import static com.difierline.lua.tokenizer.LuaTokenTypes.LEF;
import static com.difierline.lua.tokenizer.LuaTokenTypes.LOCAL;
import static com.difierline.lua.tokenizer.LuaTokenTypes.LONG_STRING;
import static com.difierline.lua.tokenizer.LuaTokenTypes.LPAREN;
import static com.difierline.lua.tokenizer.LuaTokenTypes.LT;
import static com.difierline.lua.tokenizer.LuaTokenTypes.MEAN;
import static com.difierline.lua.tokenizer.LuaTokenTypes.MINUS;
import static com.difierline.lua.tokenizer.LuaTokenTypes.MOD;
import static com.difierline.lua.tokenizer.LuaTokenTypes.MULT;
import static com.difierline.lua.tokenizer.LuaTokenTypes.NAME;
import static com.difierline.lua.tokenizer.LuaTokenTypes.NE;
import static com.difierline.lua.tokenizer.LuaTokenTypes.NEW_LINE;
import static com.difierline.lua.tokenizer.LuaTokenTypes.NIL;
import static com.difierline.lua.tokenizer.LuaTokenTypes.NOT;
import static com.difierline.lua.tokenizer.LuaTokenTypes.NUMBER;
import static com.difierline.lua.tokenizer.LuaTokenTypes.OR;
import static com.difierline.lua.tokenizer.LuaTokenTypes.PLUS;
import static com.difierline.lua.tokenizer.LuaTokenTypes.RBRACK;
import static com.difierline.lua.tokenizer.LuaTokenTypes.RCURLY;
import static com.difierline.lua.tokenizer.LuaTokenTypes.REGION;
import static com.difierline.lua.tokenizer.LuaTokenTypes.REPEAT;
import static com.difierline.lua.tokenizer.LuaTokenTypes.RETURN;
import static com.difierline.lua.tokenizer.LuaTokenTypes.RPAREN;
import static com.difierline.lua.tokenizer.LuaTokenTypes.SEMI;
import static com.difierline.lua.tokenizer.LuaTokenTypes.SHEBANG;
import static com.difierline.lua.tokenizer.LuaTokenTypes.SHEBANG_CONTENT;
import static com.difierline.lua.tokenizer.LuaTokenTypes.SHORT_COMMENT;
import static com.difierline.lua.tokenizer.LuaTokenTypes.STRING;
import static com.difierline.lua.tokenizer.LuaTokenTypes.SWITCH;
import static com.difierline.lua.tokenizer.LuaTokenTypes.THEN;
import static com.difierline.lua.tokenizer.LuaTokenTypes.TRUE;
import static com.difierline.lua.tokenizer.LuaTokenTypes.UNTIL;
import static com.difierline.lua.tokenizer.LuaTokenTypes.WHEN;
import static com.difierline.lua.tokenizer.LuaTokenTypes.WHILE;
import static com.difierline.lua.tokenizer.LuaTokenTypes.WHITE_SPACE;
import static com.difierline.lua.tokenizer.LuaTokenTypes.LAMBDA;
import static com.difierline.lua.tokenizer.LuaTokenTypes.DEFER;
 ...
 * specification file <tt>D:/JFLEX/bin/lua.flex</tt>
 */
public class LuaLexer {
    ...
    private boolean checkAhead(char c, int offset) {
        return this.zzMarkedPos + offset >= this.zzBuffer.length
                ? false
                : this.zzBuffer[this.zzMarkedPos + offset] == c;
    }
    ...
    private boolean isHighContrast(String colorStr) {
        // 空值检查
        if (colorStr == null) return false;

        // 特殊透明色处理
        if (colorStr.equalsIgnoreCase("0x00000000") || colorStr.equalsIgnoreCase("#00000000")) {
            return true;
        }
        ...
        try {
            ...
            int color;
            if (hex.length() == 8) {
                // 带透明通道：解析后6位RGB（忽略前两位AA）[1,5](@ref)
                color = Integer.parseInt(hex.substring(2), 16);
            ...
            // 计算相对亮度（sRGB亮度加权公式）[1,3](@ref)
            double luminance = (0.299 * r + 0.587 * g + 0.114 * b) / 255.0;
            return luminance < 0.65; // 使用0.6阈值判定高对比[5](@ref)
        } catch (NumberFormatException e) {
            return false; // 解析失败处理
        }
    }

    private boolean isHexColorHighlightEnabled() {
        Language lang = Lexer.getLanguage();
        if (lang instanceof LanguageLua) {
            return ((LanguageLua) lang).isHexColorHighlightEnabled();
        }
        return false;
    }
        ...
        while (true) {
            ...
            if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
                ...
                switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
                    ...
                    case 6:
                        { // 数字类型处理
                            /*if (!isHexColorHighlightEnabled()) {
                                return NUMBER; // 如果关闭高亮，直接返回数字类型
                            }

                            String numberText = yytext();

                            // 检测十六进制颜色值 (0xRRGGBB 或 0xRRGGBBAA)
                            if (numberText.startsWith("0x")) {
                                String hexPart = numberText.substring(2).toLowerCase();

                                // 检查是否为6位或8位有效十六进制数字
                                if (hexPart.matches("[0-9a-f]{6}")
                                        || hexPart.matches("[0-9a-f]{8}")) {
                                    // 判断高对比度
                                    if (isHighContrast(hexPart)) {
                                        return HEX_COLOR_HIGH_CONTRAST;
                                    } else {
                                        return HEX_COLOR; // 原有类型
                                    }
                                }
                            }*/
                            // 普通数字类型
