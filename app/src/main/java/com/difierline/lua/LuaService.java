...
//			startForeground(1, new Notification());
			...
			try {
                ...
                if (uri != null) {
                    ...
                    stopSelf();
                    showToast("LuaService: Intent.getData() is null. You must set a file:// path using setData().");
...
/*显示toast
    ...
    String channelId = "lua_service_toast";
    String channelName = "LuaService";
    ...
    Notification notification = new Notification.Builder(this, channelId)
            ...
            .setContentTitle("LuaService")
            .setContentText(text)
            .setAutoCancel(true)
            .build();

    int id = (int) System.currentTimeMillis(); // 唯一ID，避免覆盖
