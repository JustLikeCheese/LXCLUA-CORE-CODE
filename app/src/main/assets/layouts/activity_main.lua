...
local FabAboveBottomNavBehavior = bindClass "com.difierline.lua.lxclua.behavior.FabAboveBottomNavBehavior"(activity, nil)
local BottomNavigationBehavior = luajava.newInstance "com.difierline.lua.lxclua.behavior.BottomNavigationBehavior"
local HideBottomNavigationBehavior = luajava.newInstance "com.difierline.lua.lxclua.behavior.HideBottomNavigationBehavior"
