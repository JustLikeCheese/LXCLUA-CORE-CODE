...
static int os_stacksize(lua_State *L) {
  /* 从/proc/self/stat获取第28个字段（stack size） */
...
static int os_aname(lua_State *L) {
  /* 从/proc/sys/kernel/ostype获取系统代号 */
