...
#define PF_SHARED	8  /* prototype is shared across VMs */
...
typedef struct Proto {
  ...
  GCObject *gclist;
  int refcount;  /* reference count for shared prototypes */
  void *shared_owner;  /* owner of shared prototype (VM identifier) */
} Proto;
